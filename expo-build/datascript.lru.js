...
(datascript.lru.LRU.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"datascript.lru/LRU");
}));
...
var G__22635 = (new datascript.lru.LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit));
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__22635) : datascript.lru.cleanup_lru.call(null,G__22635));
}
});
...
var gen = lru.gen;
var limit = lru.limit;
var vec__22638 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22638,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22638,(1),null);
...
var datascript$lru$ICache$_get$dyn_22662 = (function (this$,key,compute_fn){
var x__5497__auto__ = (((this$ == null))?null:this$);
var m__5498__auto__ = (datascript.lru._get[goog.typeOf(x__5497__auto__)]);
if((!((m__5498__auto__ == null)))){
return (m__5498__auto__.cljs$core$IFn$_invoke$arity$3 ? m__5498__auto__.cljs$core$IFn$_invoke$arity$3(this$,key,compute_fn) : m__5498__auto__.call(null,this$,key,compute_fn));
} else {
var m__5496__auto__ = (datascript.lru._get["_"]);
if((!((m__5496__auto__ == null)))){
return (m__5496__auto__.cljs$core$IFn$_invoke$arity$3 ? m__5496__auto__.cljs$core$IFn$_invoke$arity$3(this$,key,compute_fn) : m__5496__auto__.call(null,this$,key,compute_fn));
} else {
...
return datascript$lru$ICache$_get$dyn_22662(this$,key,compute_fn);
}
});
...
*/
datascript.lru.t_datascript$lru22657 = (function (limit,_STAR_impl,meta22658){
this.limit = limit;
...
(datascript.lru.t_datascript$lru22657.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22659,meta22658__$1){
var self__ = this;
var _22659__$1 = this;
return (new datascript.lru.t_datascript$lru22657(self__.limit,self__._STAR_impl,meta22658__$1));
}));

(datascript.lru.t_datascript$lru22657.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22659){
var self__ = this;
var _22659__$1 = this;
return self__.meta22658;
}));

(datascript.lru.t_datascript$lru22657.prototype.datascript$lru$ICache$ = cljs.core.PROTOCOL_SENTINEL);

(datascript.lru.t_datascript$lru22657.prototype.datascript$lru$ICache$_get$arity$3 = (function (_,key,compute_fn){
var self__ = this;
var ___$1 = this;
...
(datascript.lru.t_datascript$lru22657.getBasis = (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"limit","limit",284709164,null),new cljs.core.Symbol(null,"*impl","*impl",1858309677,null),new cljs.core.Symbol(null,"meta22658","meta22658",1268331184,null)], null);
}));

(datascript.lru.t_datascript$lru22657.cljs$lang$type = true);

(datascript.lru.t_datascript$lru22657.cljs$lang$ctorStr = "datascript.lru/t_datascript$lru22657");

(datascript.lru.t_datascript$lru22657.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"datascript.lru/t_datascript$lru22657");
}));

/**
 * Positional factory function for datascript.lru/t_datascript$lru22657.
 */
datascript.lru.__GT_t_datascript$lru22657 = (function datascript$lru$__GT_t_datascript$lru22657(limit,_STAR_impl,meta22658){
return (new datascript.lru.t_datascript$lru22657(limit,_STAR_impl,meta22658));
});


datascript.lru.cache = (function datascript$lru$cache(limit){
var _STAR_impl = cljs.core.volatile_BANG_(datascript.lru.lru(limit));
return (new datascript.lru.t_datascript$lru22657(limit,_STAR_impl,cljs.core.PersistentArrayMap.EMPTY));
});
