...
organisms.environments.modals.example_schema = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","number","example/number",2122130080),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("db","valueType","db/valueType",1827971944),new cljs.core.Keyword("db.type","long","db.type/long",700514073),new cljs.core.Keyword("db.attr","preds","db.attr/preds",1528185167),(function (p1__38558_SHARP_){
return ((cljs.core.int_QMARK_((p1__38558_SHARP_ | (0)))) && (((((0) < (p1__38558_SHARP_ | (0)))) && (((p1__38558_SHARP_ | (0)) < (5))))));
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("example","string","example/string",-129036216),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("db","valueType","db/valueType",1827971944),new cljs.core.Keyword("db.type","string","db.type/string",1432572808),new cljs.core.Keyword("db.attr","preds","db.attr/preds",1528185167),(function (p1__38560_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("asdf",p1__38560_SHARP_);
...
var new_item_modal_content = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__38564){
var vec__38565 = p__38564;
var schema_element_title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38565,(0),null);
var schema_element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38565,(1),null);
var G__38571 = new cljs.core.Keyword("db","valueType","db/valueType",1827971944).cljs$core$IFn$_invoke$arity$1(schema_element);
var G__38571__$1 = (((G__38571 instanceof cljs.core.Keyword))?G__38571.fqn:null);
switch (G__38571__$1) {
case "db.type/long":
...
break;
default:
throw (new Error((""+"No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38571__$1))));
