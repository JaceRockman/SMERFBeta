...
if(cljs.core.truth_(cljs.core.array_QMARK_(d))){
return (d[i]);
} else {
...
var or__5141__auto__ = cljs.core.array_QMARK_(a);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return cljs.core.vector_QMARK_(a);
}
});
...
if((!((next_attr == null)))){
var G__28836 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__28836;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__28762){
var map__28763 = p__28762;
var map__28763__$1 = cljs.core.__destructure_map(map__28763);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28763__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__28763__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var idx = (function (){var or__5141__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(_STAR_kw_map),kw);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
...
var e = d.e;
var a = (function (){var G__28769 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__28769) : attrs_map.call(null,G__28769));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__28770 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__28770) : freeze_fn.call(null,G__28770));
})();
...
var v__$1 = ((typeof v === 'number')?v:((typeof v === 'string')?v:((cljs.core.boolean_QMARK_(v))?v:(cljs.core.truth_(datascript.serialize.array_QMARK_(v))?(function (){var marker = datascript.serialize.array_get(v,(0));
var pred__28794 = cljs.core._EQ__EQ_;
var expr__28795 = marker;
if(cljs.core.truth_((pred__28794.cljs$core$IFn$_invoke$arity$2 ? pred__28794.cljs$core$IFn$_invoke$arity$2((0),expr__28795) : pred__28794.call(null,(0),expr__28795)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__28794.cljs$core$IFn$_invoke$arity$2 ? pred__28794.cljs$core$IFn$_invoke$arity$2((1),expr__28795) : pred__28794.call(null,(1),expr__28795)))){
var G__28799 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__28799) : thaw_fn.call(null,G__28799));
} else {
if(cljs.core.truth_((pred__28794.cljs$core$IFn$_invoke$arity$2 ? pred__28794.cljs$core$IFn$_invoke$arity$2((2),expr__28795) : pred__28794.call(null,(2),expr__28795)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__28794.cljs$core$IFn$_invoke$arity$2 ? pred__28794.cljs$core$IFn$_invoke$arity$2((3),expr__28795) : pred__28794.call(null,(3),expr__28795)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__28794.cljs$core$IFn$_invoke$arity$2 ? pred__28794.cljs$core$IFn$_invoke$arity$2((4),expr__28795) : pred__28794.call(null,(4),expr__28795)))){
return NaN;
} else {
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((""+"Unexpected value marker "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([marker], 0)))+" in "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0))], 0)))),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"serialize","serialize",-69216574),new cljs.core.Keyword(null,"value","value",305978217),v], null));
}
}
}
}
}
})():(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2((""+"Unexpected value type "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.type(v)], 0)))+" ("+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0))], 0)))+")"),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"error","error",-978969032),new cljs.core.Keyword(null,"serialize","serialize",-69216574),new cljs.core.Keyword(null,"value","value",305978217),v], null))})()
))));
...
var aevt = (function (){var G__28814 = datascript.serialize.dict_get(from,"aevt");
if((G__28814 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__28778_SHARP_){
return (eavt[p1__28778_SHARP_]);
}),G__28814);
}
})();
var avet = (function (){var G__28816 = datascript.serialize.dict_get(from,"avet");
if((G__28816 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__28779_SHARP_){
return (eavt[p1__28779_SHARP_]);
}),G__28816);
}
})();
var settings = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"branching-factor","branching-factor",1903198601),datascript.serialize.dict_get(from,"branching-factor"),new cljs.core.Keyword(null,"ref-type","ref-type",-1367328851),(function (){var G__28821 = datascript.serialize.dict_get(from,"ref-type");
if((G__28821 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__28821);
}
