...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30844_SHARP_){
return clojure.string.includes_QMARK_(clojure.string.lower_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.vals(p1__30844_SHARP_))),clojure.string.lower_case((function (){var temp__5823__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(entities.resources.views.resource_search_text),component_key);
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_native.View,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"flex-direction","flex-direction",364609438),new cljs.core.Keyword(null,"row","row",-570139521)], null)], null),cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30845_SHARP_){
return entities.resources.views.toggle_filter_button(entities.resources.views.resource_type_filters_list,entities.resources.views.active_resource_filter_lists,active_filter_list_key,p1__30845_SHARP_);
...
entities.resources.views.creature_resource_column_headers = new cljs.core.PersistentArrayMap(null, 4, ["Title",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Title",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30846_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__30846_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("creature-resource","resource","creature-resource/resource",-3690952),new cljs.core.Keyword(null,"title","title",636505583)], null));
})], null),"Quality",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Quality",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30847_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__30847_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("creature-resource","resource","creature-resource/resource",-3690952),new cljs.core.Keyword("resource","quality-value","resource/quality-value",-1702050437)], null));
})], null),"Power",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Power",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30848_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__30848_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("creature-resource","resource","creature-resource/resource",-3690952),new cljs.core.Keyword("resource","power-value","resource/power-value",-1448641423)], null));
})], null),"Quantity",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Quantity",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30849_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__30849_SHARP_,new cljs.core.Keyword("creature-resource","quantity","creature-resource/quantity",2108753046));
})], null)], null);
entities.resources.views.resource_column_headers = new cljs.core.PersistentArrayMap(null, 3, ["Title",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Title",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30850_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__30850_SHARP_,new cljs.core.Keyword(null,"title","title",636505583));
})], null),"Quality",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Quality",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30851_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__30851_SHARP_,new cljs.core.Keyword("resource","quality-value","resource/quality-value",-1702050437));
})], null),"Power",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"header","header",119441134),"Power",new cljs.core.Keyword(null,"sort-fn","sort-fn",977815011),(function (p1__30852_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__30852_SHARP_,new cljs.core.Keyword("resource","power-value","resource/power-value",-1448641423));
})], null)], null);
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__30853_SHARP_){
return cljs.core.empty_QMARK_(new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(p1__30853_SHARP_));
...
var temp__5825__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(grouped_resources,resource_type);
if(cljs.core.truth_(temp__5825__auto__)){
var resource_data = temp__5825__auto__;
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__30854_SHARP_){
return entities.resources.views.sort_sections(grouped_resources,p1__30854_SHARP_);
...
return entities.resources.views.sort_resources_by_type.cljs$core$IFn$_invoke$arity$2(creature_resources,(function (p1__30857_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__30857_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("creature-resource","resource","creature-resource/resource",-3690952),new cljs.core.Keyword("resource","type","resource/type",2041163162)], null));
}));
});
...
return new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_native.View,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"100%"], null)], null),(function (){var G__30858 = new cljs.core.Keyword(null,"title","title",636505583).cljs$core$IFn$_invoke$arity$1(resource);
var G__30859 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(24)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30858,G__30859) : organisms.library.default_text.call(null,G__30858,G__30859));
})(),(function (){var G__30860 = (""+"("+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("resource","type","resource/type",2041163162).cljs$core$IFn$_invoke$arity$1(resource))+")");
var G__30861 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(12)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30860,G__30861) : organisms.library.default_text.call(null,G__30860,G__30861));
})(),(function (){var G__30862 = new cljs.core.Keyword("resource","description","resource/description",-683595378).cljs$core$IFn$_invoke$arity$1(resource);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30862) : organisms.library.default_text.call(null,G__30862));
})(),(function (){var G__30863 = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("resource","quality-title","resource/quality-title",-1451866234).cljs$core$IFn$_invoke$arity$1(resource))+": "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("resource","quality-value","resource/quality-value",-1702050437).cljs$core$IFn$_invoke$arity$1(resource)));
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30863) : organisms.library.default_text.call(null,G__30863));
})(),(function (){var G__30864 = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("resource","power-title","resource/power-title",959882574).cljs$core$IFn$_invoke$arity$1(resource))+": "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("resource","power-value","resource/power-value",-1448641423).cljs$core$IFn$_invoke$arity$1(resource)));
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30864) : organisms.library.default_text.call(null,G__30864));
})(),(function (){var temp__5825__auto__ = (function (){var G__30865 = conn;
var G__30866 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(resource);
return (entities.resources.data.interface$.get_resource_actions.cljs$core$IFn$_invoke$arity$2 ? entities.resources.data.interface$.get_resource_actions.cljs$core$IFn$_invoke$arity$2(G__30865,G__30866) : entities.resources.data.interface$.get_resource_actions.call(null,G__30865,G__30866));
})();
if(cljs.core.truth_(temp__5825__auto__)){
var resource_actions = temp__5825__auto__;
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(organisms.library.text_input_map,(function (p1__30867_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__30867_SHARP_,type_id,type_title);
}));
...
entities.resources.views.resource_property_select_button = (function entities$resources$views$resource_property_select_button(type_id,p__30870){
var map__30871 = p__30870;
var map__30871__$1 = cljs.core.__destructure_map(map__30871);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30871__$1,new cljs.core.Keyword("resource-property","title","resource-property/title",-1249508581));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30871__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
var selected_QMARK_ = cljs.core.some((function (p1__30868_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,p1__30868_SHARP_);
...
var new_property_vals = (cljs.core.truth_(selected_QMARK_)?cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30869_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__30869_SHARP_,id)));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_native.View,(function (){var G__30872 = (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1("Properties:") : organisms.library.default_text.call(null,"Properties:"));
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30872) : organisms.library.default_text.call(null,G__30872));
...
return new cljs.core.PersistentVector(null, 11, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_native.ScrollView,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),(5)], null)], null),(function (){var G__30873 = (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1("Title:") : organisms.library.default_text.call(null,"Title:"));
var G__30874 = "new-resource-title";
return (organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2(G__30873,G__30874) : organisms.library.default_text_input.call(null,G__30873,G__30874));
})(),entities.resources.views.resource_type_select("new-resource-type"),entities.resources.views.resource_property_select(conn,"new-resource-properties"),(function (){var G__30875 = (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1("Actions:") : organisms.library.default_text.call(null,"Actions:"));
var G__30876 = "new-resource-actions";
return (organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2(G__30875,G__30876) : organisms.library.default_text_input.call(null,G__30875,G__30876));
})(),(function (){var G__30877 = (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1("Quality:") : organisms.library.default_text.call(null,"Quality:"));
var G__30878 = "new-resource-quality";
return (organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2(G__30877,G__30878) : organisms.library.default_text_input.call(null,G__30877,G__30878));
})(),(function (){var G__30879 = (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1("Power:") : organisms.library.default_text.call(null,"Power:"));
var G__30880 = "new-resource-power";
return (organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2(G__30879,G__30880) : organisms.library.default_text_input.call(null,G__30879,G__30880));
})(),(function (){var G__30881 = (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1("Description:") : organisms.library.default_text.call(null,"Description:"));
var G__30882 = "new-resource-description";
return (organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text_input.cljs$core$IFn$_invoke$arity$2(G__30881,G__30882) : organisms.library.default_text_input.call(null,G__30881,G__30882));
})(),(function (){var G__30883 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-press","on-press",-1763585856),(function (){
var G__30885_30940 = conn;
var G__30886_30941 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__30887){
var vec__30888 = p__30887;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30888,(0),null);
...
(entities.resources.data.interface$.create_resource.cljs$core$IFn$_invoke$arity$2 ? entities.resources.data.interface$.create_resource.cljs$core$IFn$_invoke$arity$2(G__30885_30940,G__30886_30941) : entities.resources.data.interface$.create_resource.call(null,G__30885_30940,G__30886_30941));

return cljs.core.reset_BANG_(organisms.library.text_input_map,cljs.core.PersistentArrayMap.EMPTY);
})], null);
var G__30884 = "Save!";
return (organisms.library.button.cljs$core$IFn$_invoke$arity$2 ? organisms.library.button.cljs$core$IFn$_invoke$arity$2(G__30883,G__30884) : organisms.library.button.call(null,G__30883,G__30884));
})()], null);
});
entities.resources.views.creature_resource_modal = (function entities$resources$views$creature_resource_modal(conn,p__30891,quantity){
var map__30892 = p__30891;
var map__30892__$1 = cljs.core.__destructure_map(map__30892);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"title","title",636505583));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var quality_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"quality-title","quality-title",-16635012));
var quality_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"quality-value","quality-value",540051845));
var power_title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"power-title","power-title",1267360032));
var power_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30892__$1,new cljs.core.Keyword(null,"power-value","power-value",-581715901));
return new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),shadow.js.shim.module$react_native.View,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"height","height",1025178622),"100%"], null)], null),(function (){var G__30893 = title;
var G__30894 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(24)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30893,G__30894) : organisms.library.default_text.call(null,G__30893,G__30894));
})(),(function (){var G__30895 = (""+"("+cljs.core.str.cljs$core$IFn$_invoke$arity$1(type)+")");
var G__30896 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(12)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30895,G__30896) : organisms.library.default_text.call(null,G__30895,G__30896));
})(),(organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(description) : organisms.library.default_text.call(null,description)),(function (){var G__30897 = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(quality_title)+": "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(quality_value));
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30897) : organisms.library.default_text.call(null,G__30897));
})(),(function (){var G__30898 = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(power_title)+": "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(power_value));
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30898) : organisms.library.default_text.call(null,G__30898));
})(),(cljs.core.truth_(quantity)?(function (){var G__30899 = (""+"Quantity: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5141__auto__ = quantity;
...
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$1 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$1(G__30899) : organisms.library.default_text.call(null,G__30899));
...
return (function (p__30900){
var map__30901 = p__30900;
var map__30901__$1 = cljs.core.__destructure_map(map__30901);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30901__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30901__$1,new cljs.core.Keyword(null,"title","title",636505583));
var quality_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30901__$1,new cljs.core.Keyword(null,"quality-value","quality-value",540051845));
var power_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30901__$1,new cljs.core.Keyword(null,"power-value","power-value",-581715901));
...
})], null),(function (){var G__30902 = title;
var G__30903 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(0)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30902,G__30903) : organisms.library.default_text.call(null,G__30902,G__30903));
})(),(function (){var G__30904 = quality_value;
var G__30905 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(1)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30904,G__30905) : organisms.library.default_text.call(null,G__30904,G__30905));
})(),(function (){var G__30906 = power_value;
var G__30907 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(2)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30906,G__30907) : organisms.library.default_text.call(null,G__30906,G__30907));
})()], null);
});
});
...
var resource = map__30909__$1;
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30909__$1,new cljs.core.Keyword(null,"title","title",636505583));
var quality_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30909__$1,new cljs.core.Keyword(null,"quality-value","quality-value",540051845));
var power_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30909__$1,new cljs.core.Keyword(null,"power-value","power-value",-581715901));
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30909__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
})], null),(function (){var G__30910 = title;
var G__30911 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(0)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30910,G__30911) : organisms.library.default_text.call(null,G__30910,G__30911));
})(),(function (){var G__30912 = quality_value;
var G__30913 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(1)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30912,G__30913) : organisms.library.default_text.call(null,G__30912,G__30913));
})(),(function (){var G__30914 = power_value;
var G__30915 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(2)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30914,G__30915) : organisms.library.default_text.call(null,G__30914,G__30915));
})()], null);
});
});
...
var stuff = map__30917__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30917__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var map__30918 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30917__$1,new cljs.core.Keyword(null,"resource","resource",251898836));
var map__30918__$1 = cljs.core.__destructure_map(map__30918);
var resource = map__30918__$1;
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30918__$1,new cljs.core.Keyword(null,"title","title",636505583));
var quality_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30918__$1,new cljs.core.Keyword(null,"quality-value","quality-value",540051845));
var power_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30918__$1,new cljs.core.Keyword(null,"power-value","power-value",-581715901));
var quantity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30917__$1,new cljs.core.Keyword(null,"quantity","quantity",-1929050694));
...
})], null),(function (){var G__30919 = title;
var G__30920 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(0)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30919,G__30920) : organisms.library.default_text.call(null,G__30919,G__30920));
})(),(function (){var G__30921 = quality_value;
var G__30922 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(1)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30921,G__30922) : organisms.library.default_text.call(null,G__30921,G__30922));
})(),(function (){var G__30923 = power_value;
var G__30924 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"flex","flex",-1425124628),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(flex_vals,(2)),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(16),new cljs.core.Keyword(null,"text-align","text-align",1786091845),new cljs.core.Keyword(null,"center","center",-748944368)], null);
return (organisms.library.default_text.cljs$core$IFn$_invoke$arity$2 ? organisms.library.default_text.cljs$core$IFn$_invoke$arity$2(G__30923,G__30924) : organisms.library.default_text.call(null,G__30923,G__30924));
...
var active_filter_list = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__30929_SHARP_){
return cljs.core.last(p1__30929_SHARP_);
...
var resource_ids = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,(function (){var G__30930 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"find","find",496279456),((creature_resources_QMARK_)?new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?eid","?eid",1087837141,null)], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?resource-id","?resource-id",1439255238,null)], null)),new cljs.core.Keyword(null,"where","where",-2044795965),where_vector], null);
var G__30931 = cljs.core.deref(conn);
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__30930,G__30931) : datascript.core.q.call(null,G__30930,G__30931));
})());
var resources = (function (){var G__30932 = cljs.core.deref(conn);
var G__30933 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__30934 = resource_ids;
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__30932,G__30933,G__30934) : datascript.core.pull_many.call(null,G__30932,G__30933,G__30934));
})();
...
entities.resources.views.resource_list = (function entities$resources$views$resource_list(conn,p__30935){
var map__30936 = p__30935;
var map__30936__$1 = cljs.core.__destructure_map(map__30936);
var search_filter_query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"search-filter-query","search-filter-query",-163807358));
var item_format_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"item-format-fn","item-format-fn",-1806627887));
var new_item_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"new-item-fn","new-item-fn",-847841493));
var sort_manager = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"sort-manager","sort-manager",502299230));
var sfs_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"sfs-component","sfs-component",-1971113144));
var quantity_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"quantity?","quantity?",-378141106));
var list_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30936__$1,new cljs.core.Keyword(null,"list-key","list-key",1563228021));
...
var G__30937 = new cljs.core.PersistentArrayMap(null, 8, [new cljs.core.Keyword(null,"list-header","list-header",-862823076),"Resources",new cljs.core.Keyword(null,"column-flex-vals","column-flex-vals",-637482818),flex_vals,new cljs.core.Keyword(null,"column-headers","column-headers",-966500841),headers,new cljs.core.Keyword(null,"items","items",1031954938),(function (){var or__5141__auto__ = search_filter_query;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return entities.resources.views.resource_search_filter_query(conn,entities.resources.views.active_resource_filter_lists,(function (){var or__5141__auto____$1 = list_key;
...
})(),new cljs.core.Keyword(null,"item-format-fn","item-format-fn",-1806627887),(function (){var or__5141__auto__ = item_format_fn;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return entities.resources.views.resource_row_component(conn,flex_vals);
}
})(),new cljs.core.Keyword(null,"new-item-fn","new-item-fn",-847841493),(function (){var or__5141__auto__ = new_item_fn;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return (function (){
...
})(),new cljs.core.Keyword(null,"sort-manager","sort-manager",502299230),sort_manager,new cljs.core.Keyword(null,"search-filter-sort-component","search-filter-sort-component",-852643056),(function (){var or__5141__auto__ = sfs_component;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
...
var G__30938 = (1);
return (organisms.library.search_filter_sort_list.cljs$core$IFn$_invoke$arity$2 ? organisms.library.search_filter_sort_list.cljs$core$IFn$_invoke$arity$2(G__30937,G__30938) : organisms.library.search_filter_sort_list.call(null,G__30937,G__30938));
});
