...
return (function (){var or__5141__auto__ = w.requestAnimationFrame;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
var or__5141__auto____$1 = w.webkitRequestAnimationFrame;
if(cljs.core.truth_(or__5141__auto____$1)){
return or__5141__auto____$1;
} else {
var or__5141__auto____$2 = w.mozRequestAnimationFrame;
if(cljs.core.truth_(or__5141__auto____$2)){
return or__5141__auto____$2;
} else {
var or__5141__auto____$3 = w.msRequestAnimationFrame;
...
var n__5740__auto__ = fs.length;
var i = (0);
while(true){
if((i < n__5740__auto__)){
var fexpr__22053_22076 = (fs[i]);
(fexpr__22053_22076.cljs$core$IFn$_invoke$arity$0 ? fexpr__22053_22076.cljs$core$IFn$_invoke$arity$0() : fexpr__22053_22076.call(null));
...
var G__22058 = (function (){
return this$.run_queues();
});
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__22058) : reagent.impl.batching.next_tick.call(null,G__22058));
}
}));
...
(reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"reagent.impl.batching/RenderQueue");
}));
