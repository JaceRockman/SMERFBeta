...
var G__22661 = shadow_root.activeElement;
active_element = G__22661;
continue;
} else {
...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__22642){
var map__22643 = p__22642;
var map__22643__$1 = cljs.core.__destructure_map(map__22643);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22643__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
if(cljs.core.truth_((function (){var or__5141__auto__ = (!((((node === reagent.impl.input.get_true_active_element())) && (((reagent.impl.input.has_selection_api_QMARK_(node.type)) && (((typeof rendered_value === 'string') && (typeof dom_value === 'string'))))))));
if(or__5141__auto__){
...
var _STAR_force_set_dom_value_STAR__orig_val__22644 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__22645 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__22645);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__22644);
}}));
} else {
...
if(cljs.core.truth_((function (){var and__5139__auto__ = (!((jsprops == null)));
if(and__5139__auto__){
var and__5139__auto____$1 = jsprops.hasOwnProperty("onChange");
...
}):(cljs.core.truth_((function (){var and__5139__auto__ = original_ref_fn;
...
(jsprops.onChange = (function (p1__22656_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__22656_SHARP_);
}));
