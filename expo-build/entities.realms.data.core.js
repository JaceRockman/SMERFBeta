...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,(function (){var G__38862 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"entity-type","entity-type",-1957300125),"realm"], null)], null);
var G__38863 = cljs.core.deref(conn);
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__38862,G__38863) : datascript.core.q.call(null,G__38862,G__38863));
})());
});
entities.realms.data.core.get_all_realms = (function entities$realms$data$core$get_all_realms(conn){
var temp__5825__auto__ = entities.realms.data.core.get_all_realm_ids(conn);
if(cljs.core.truth_(temp__5825__auto__)){
var realm_ids = temp__5825__auto__;
var G__38864 = cljs.core.deref(conn);
var G__38865 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__38866 = realm_ids;
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__38864,G__38865,G__38866) : datascript.core.pull_many.call(null,G__38864,G__38865,G__38866));
} else {
return null;
}
});
...
var parent_entities = (function (){var G__38870 = cljs.core.deref(conn);
var G__38871 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("realm","_children-entities","realm/_children-entities",-707069175)], null);
var G__38872 = id;
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__38870,G__38871,G__38872) : datascript.core.pull.call(null,G__38870,G__38871,G__38872));
})();
...
var new_parents = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38867_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__38867_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("realm","_children-entities","realm/_children-entities",-707069175),new cljs.core.Keyword("db","id","db/id",-1388397098)], null));
}),(function (){var G__38873 = cljs.core.deref(conn);
var G__38874 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("realm","_children-entities","realm/_children-entities",-707069175)], null);
var G__38875 = new_ids;
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__38873,G__38874,G__38875) : datascript.core.pull_many.call(null,G__38873,G__38874,G__38875));
})()));
...
var children_entities = (function (){var G__38878 = cljs.core.deref(conn);
var G__38879 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("realm","children-entities","realm/children-entities",-1721912849)], null);
var G__38880 = id;
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__38878,G__38879,G__38880) : datascript.core.pull.call(null,G__38878,G__38879,G__38880));
})();
...
var new_children = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("realm","children-entities","realm/children-entities",-1721912849),cljs.core.flatten((function (){var G__38881 = cljs.core.deref(conn);
var G__38882 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("realm","children-entities","realm/children-entities",-1721912849)], null);
var G__38883 = new_ids;
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__38881,G__38882,G__38883) : datascript.core.pull_many.call(null,G__38881,G__38882,G__38883));
})())))));
...
var all_entities = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38884_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(realm_entity_id,p1__38884_SHARP_)));
...
var G__38885 = cljs.core.deref(conn);
var G__38886 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__38887 = all_entities;
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__38885,G__38886,G__38887) : datascript.core.pull_many.call(null,G__38885,G__38886,G__38887));
} else {
return null;
}
});
...
var all_entities = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38888_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(realm_id,p1__38888_SHARP_)));
}),entities.realms.data.core.recursively_get_children_entities.cljs$core$IFn$_invoke$arity$2(conn,realm_id));
if(cljs.core.seq(all_entities)){
var G__38889 = cljs.core.deref(conn);
var G__38890 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__38891 = all_entities;
return (datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull_many.cljs$core$IFn$_invoke$arity$3(G__38889,G__38890,G__38891) : datascript.core.pull_many.call(null,G__38889,G__38890,G__38891));
} else {
return null;
}
});
entities.realms.data.core.get_active_realm_id = (function entities$realms$data$core$get_active_realm_id(conn){
var map__38892 = systems.navigation.get_nav_state(conn);
var map__38892__$1 = cljs.core.__destructure_map(map__38892);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38892__$1,new cljs.core.Keyword(null,"page","page",849072397));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38892__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"realms","realms",1714748568),page)) && (((0) < cljs.core.count(query_params))))){
...
var temp__5825__auto__ = entities.realms.data.core.get_active_realm_id(conn);
if(cljs.core.truth_(temp__5825__auto__)){
var active_realm_id = temp__5825__auto__;
var G__38893 = cljs.core.deref(conn);
var G__38894 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__38895 = (active_realm_id | (0));
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__38893,G__38894,G__38895) : datascript.core.pull.call(null,G__38893,G__38894,G__38895));
} else {
return null;
}
});
entities.realms.data.core.get_realm_id_by_name = (function entities$realms$data$core$get_realm_id_by_name(conn,realm_name){
return cljs.core.ffirst((function (){var G__38896 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?realm-name","?realm-name",-1708941404,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"title","title",636505583),new cljs.core.Symbol(null,"?realm-name","?realm-name",-1708941404,null)], null)], null);
var G__38897 = cljs.core.deref(conn);
var G__38898 = realm_name;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__38896,G__38897,G__38898) : datascript.core.q.call(null,G__38896,G__38897,G__38898));
})());
});
entities.realms.data.core.set_active_realm = (function entities$realms$data$core$set_active_realm(conn,realm_id){
return systems.navigation.subnavigate_BANG_(conn,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"realms","realms",1714748568),new cljs.core.Keyword(null,"query-params","query-params",900640534),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [realm_id], null)], null));
});
entities.realms.data.core.get_active_subrealm_id = (function entities$realms$data$core$get_active_subrealm_id(conn){
var map__38899 = systems.navigation.get_nav_state(conn);
var map__38899__$1 = cljs.core.__destructure_map(map__38899);
var page = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38899__$1,new cljs.core.Keyword(null,"page","page",849072397));
var query_params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38899__$1,new cljs.core.Keyword(null,"query-params","query-params",900640534));
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"realms","realms",1714748568),page)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((3),cljs.core.count(query_params))))){
return (cljs.core.last(query_params) | (0));
} else {
return null;
}
});
entities.realms.data.core.get_active_subrealm = (function entities$realms$data$core$get_active_subrealm(conn){
var temp__5825__auto__ = entities.realms.data.core.get_active_subrealm_id(conn);
if(cljs.core.truth_(temp__5825__auto__)){
var active_subrealm = temp__5825__auto__;
var G__38900 = cljs.core.deref(conn);
var G__38901 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__38902 = (active_subrealm | (0));
return (datascript.core.pull.cljs$core$IFn$_invoke$arity$3 ? datascript.core.pull.cljs$core$IFn$_invoke$arity$3(G__38900,G__38901,G__38902) : datascript.core.pull.call(null,G__38900,G__38901,G__38902));
} else {
return null;
}
});
...
return cljs.core.ffirst((function (){var G__38903 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?subrealm-name","?subrealm-name",667784447,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"title","title",636505583),new cljs.core.Symbol(null,"?subrealm-name","?subrealm-name",667784447,null)], null)], null);
var G__38904 = cljs.core.deref(conn);
var G__38905 = subrealm_name;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__38903,G__38904,G__38905) : datascript.core.q.call(null,G__38903,G__38904,G__38905));
})());
});
...
return cljs.core.ffirst((function (){var G__38906 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("active","subrealm","active/subrealm",-704364530)], null)], null);
var G__38907 = cljs.core.deref(conn);
return (datascript.core.q.cljs$core$IFn$_invoke$arity$2 ? datascript.core.q.cljs$core$IFn$_invoke$arity$2(G__38906,G__38907) : datascript.core.q.call(null,G__38906,G__38907));
})());
});
entities.realms.data.core.set_active_subrealm = (function entities$realms$data$core$set_active_subrealm(conn,subrealm_id){
return systems.navigation.subnavigate_BANG_(conn,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"realms","realms",1714748568),new cljs.core.Keyword(null,"query-params","query-params",900640534),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [subrealm_id], null)], null));
});
