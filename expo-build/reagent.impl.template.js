...
(reagent.impl.template.UnsafeHTML.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"reagent.impl.template/UnsafeHTML");
}));
...
(reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__22701 = o;
reagent.impl.template.goog$module$goog$object.set(G__22701,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23064__delegate = function (args){
...
while (G__23065__i < G__23065__a.length) {G__23065__a[G__23065__i] = arguments[G__23065__i + 0]; ++G__23065__i;}
  args = new cljs.core.IndexedSeq(G__23065__a,0,null);
} 
return G__23064__delegate.call(this,args);};
G__23064.cljs$lang$maxFixedArity = 0;
G__23064.cljs$lang$applyTo = (function (arglist__23066){
var args = cljs.core.seq(arglist__23066);
return G__23064__delegate(args);
});
...
var G__22712 = o;
reagent.impl.template.goog$module$goog$object.set(G__22712,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__23068__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__23068 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__23069__i < G__23069__a.length) {G__23069__a[G__23069__i] = arguments[G__23069__i + 0]; ++G__23069__i;}
  args = new cljs.core.IndexedSeq(G__23069__a,0,null);
} 
return G__23068__delegate.call(this,args);};
G__23068.cljs$lang$maxFixedArity = 0;
G__23068.cljs$lang$applyTo = (function (arglist__23070){
var args = cljs.core.seq(arglist__23070);
return G__23068__delegate(args);
});
...
var G__22813 = props;
var G__22813__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22813,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22813);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22813__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5141__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22818 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22818,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22818;
}
})(),id_class);
...
var temp__5825__auto___23071 = (function (){var and__5139__auto__ = js_props;
...
if(cljs.core.truth_(temp__5825__auto___23071)){
var d_23072 = temp__5825__auto___23071;
if((d_23072 instanceof reagent.impl.template.UnsafeHTML)){
(js_props.dangerouslySetInnerHTML = ({"__html": d_23072.s}));
} else {
...
var G__22828 = (cljs.core.count(argv) - first_child);
switch (G__22828) {
case (0):
...
(reagent.impl.template.HiccupTag.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__22839 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22839,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22839,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22839,(2),null);
...
var temp__5829__auto___23076 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___23076 == null)){
} else {
var key_23077 = temp__5829__auto___23076;
(jsprops.key = key_23077);
}
...
var temp__5829__auto___23080 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___23080 == null)){
} else {
var key_23081 = temp__5829__auto___23080;
(jsprops.key = key_23081);
}
...
var temp__5829__auto___23082 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___23082 == null)){
} else {
var key_23083 = temp__5829__auto___23082;
(jsprops.key = key_23083);
}
...
var jsprops = (function (){var or__5141__auto__ = reagent.impl.template.convert_prop_value(((hasprops)?props:null));
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return ({});
...
var temp__5829__auto___23086 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___23086 == null)){
} else {
var key_23087 = temp__5829__auto___23086;
(jsprops.key = key_23087);
}
...
var hasprops = (((props == null)) || (cljs.core.map_QMARK_(props)));
var jsprops = (function (){var or__5141__auto__ = reagent.impl.template.convert_props(((hasprops)?props:null),parsed);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return ({});
...
var input_class = (function (){var or__5141__auto__ = compiler.reagentInput;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
...
var temp__5829__auto___23097 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___23097 == null)){
} else {
var key_23098 = temp__5829__auto___23097;
(jsprops.key = key_23098);
}
...
var jsprops = (function (){var or__5141__auto__ = props;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return ({});
...
var temp__5829__auto___23103 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___23103 == null)){
} else {
var key_23104 = temp__5829__auto___23103;
(jsprops.key = key_23104);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22924_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22924_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22961 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22961,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22961,(1),null);
...
break;
default:
var G__23113 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__23114 = compiler;
v = G__23113;
compiler = G__23114;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template23040 = (function (opts,id,fn_to_element,parse_fn,meta23041){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template23040.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_23042,meta23041__$1){
var self__ = this;
var _23042__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template23040(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta23041__$1));
}));

(reagent.impl.template.t_reagent$impl$template23040.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_23042){
var self__ = this;
var _23042__$1 = this;
return self__.meta23041;
}));

(reagent.impl.template.t_reagent$impl$template23040.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template23040.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template23040.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template23040.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template23040.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template23040.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta23041","meta23041",-1373053288,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template23040.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template23040.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template23040");

(reagent.impl.template.t_reagent$impl$template23040.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"reagent.impl.template/t_reagent$impl$template23040");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template23040.
 */
reagent.impl.template.__GT_t_reagent$impl$template23040 = (function reagent$impl$template$__GT_t_reagent$impl$template23040(opts,id,fn_to_element,parse_fn,meta23041){
return (new reagent.impl.template.t_reagent$impl$template23040(opts,id,fn_to_element,parse_fn,meta23041));
});
...
return (new reagent.impl.template.t_reagent$impl$template23040(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
