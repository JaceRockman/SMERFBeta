...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22376 = c;
var G__22376__$1 = (((G__22376 == null))?null:G__22376.prototype);
if((G__22376__$1 == null)){
return null;
} else {
return G__22376__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22380 = c;
var G__22380__$1 = (((G__22380 == null))?null:G__22380.prototype);
if((G__22380__$1 == null)){
return null;
} else {
return G__22380__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__22586__delegate = function (args){
...
var G__22586 = function (var_args){
var args = null;
...
while (G__22587__i < G__22587__a.length) {G__22587__a[G__22587__i] = arguments[G__22587__i + 0]; ++G__22587__i;}
  args = new cljs.core.IndexedSeq(G__22587__a,0,null);
} 
return G__22586__delegate.call(this,args);};
G__22586.cljs$lang$maxFixedArity = 0;
G__22586.cljs$lang$applyTo = (function (arglist__22588){
var args = cljs.core.seq(arglist__22588);
return G__22586__delegate(args);
});
...
var or__5141__auto__ = (function (){var G__22399 = c;
var G__22399__$1 = (((G__22399 == null))?null:G__22399.constructor);
if((G__22399__$1 == null)){
return null;
} else {
return G__22399__$1.displayName;
}
})();
...
var G__22401 = c;
var G__22401__$1 = (((G__22401 == null))?null:G__22401.constructor);
if((G__22401__$1 == null)){
return null;
} else {
return G__22401__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__22417 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22418 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22418);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22417);
}});
...
var G__22420 = reagent.impl.component.goog$module$goog$object.get(component_state,"cljsRatom");
if((G__22420 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22420);
}
} else {
return null;
}
...
var or__5141__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
var c = this;
...
if((f == null)){
var or__5141__auto____$1 = noargv;
...
if(cljs.core.truth_((function (){var and__5139__auto__ = wrap;
...
var renders_22602 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22603 = cljs.core.first(cljs.core.vals(renders_22602));
...
if((cljs.core.count(renders_22602) > (0))){
} else {
throw (new Error((""+"Assert failed: "+"Missing reagent-render"+"\n"+"(pos? (count renders))")));
}

if(((1) === cljs.core.count(renders_22602))){
} else {
throw (new Error((""+"Assert failed: "+"Too many render functions supplied"+"\n"+"(== 1 (count renders))")));
}

if(cljs.core.ifn_QMARK_(render_fun_22603)){
} else {
throw (new Error((""+"Assert failed: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((""+"Expected something callable, not "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22603], 0)))))+"\n"+"(clojure.core/ifn? render-fun)")));
}


var render_fun = (function (){var or__5141__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
...
var name = (function (){var or__5141__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
var or__5141__auto____$1 = reagent.impl.util.fun_name(render_fun);
...
var G__22481 = o;
reagent.impl.component.goog$module$goog$object.set(G__22481,cljs.core.name(k),v);
...
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn((""+"Warning: "+"Using native React classes directly in Hiccup forms "+"is not supported. Use create-element or "+"adapt-react-class instead: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__5141__auto__ = reagent.impl.util.fun_name(f);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return f;
...
return (function() { 
var G__22614__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__22614 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__22615__i = 0, G__22615__a = new Array(arguments.length -  0);
while (G__22615__i < G__22615__a.length) {G__22615__a[G__22615__i] = arguments[G__22615__i + 0]; ++G__22615__i;}
  args = new cljs.core.IndexedSeq(G__22615__a,0,null);
} 
return G__22614__delegate.call(this,args);};
G__22614.cljs$lang$maxFixedArity = 0;
G__22614.cljs$lang$applyTo = (function (arglist__22616){
var args = cljs.core.seq(arglist__22616);
return G__22614__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__22557 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22558 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22558);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22557);
}});
...
var vec__22566 = shadow.js.shim.module$react.useReducer(cljs.core.inc,(0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(0),null);
var force_update = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22566,(1),null);
...
var and__5139__auto__ = reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__5139__auto__){
try{return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_argv,new_argv);
}catch (e22573){var e = e22573;
if(reagent.debug.has_console){
((reagent.debug.tracking)?reagent.debug.track_console:console).warn((""+"Warning: "+"Exception thrown while comparing argv's in shouldComponentUpdate: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)+" "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)+" "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)));
} else {
}
...
var or__5141__auto__ = reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
