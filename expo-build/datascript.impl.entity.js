...
var G__26456 = db;
var G__26457 = e;
var G__26458 = cljs.core.volatile_BANG_(false);
var G__26459 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__26456,G__26457,G__26458,G__26459) : datascript.impl.entity.__GT_Entity.call(null,G__26456,G__26457,G__26458,G__26459));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26467_SHARP_,p2__26468_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__26467_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__26468_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26469_SHARP_,p2__26470_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__26469_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__26470_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26481_SHARP_,p2__26482_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__26481_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__26482_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5627__auto__ = (function datascript$impl$entity$js_seq_$_iter__26494(s__26495){
return (new cljs.core.LazySeq(null,(function (){
var s__26495__$1 = s__26495;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__26495__$1);
if(temp__5825__auto__){
var s__26495__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26495__$2)){
var c__5625__auto__ = cljs.core.chunk_first(s__26495__$2);
var size__5626__auto__ = cljs.core.count(c__5625__auto__);
var b__26497 = cljs.core.chunk_buffer(size__5626__auto__);
if((function (){var i__26496 = (0);
while(true){
if((i__26496 < size__5626__auto__)){
var vec__26509 = cljs.core._nth(c__5625__auto__,i__26496);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26509,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26509,(1),null);
cljs.core.chunk_append(b__26497,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__26896 = (i__26496 + (1));
i__26496 = G__26896;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26497),datascript$impl$entity$js_seq_$_iter__26494(cljs.core.chunk_rest(s__26495__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26497),null);
}
} else {
var vec__26516 = cljs.core.first(s__26495__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26516,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26516,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__26494(cljs.core.rest(s__26495__$2)));
}
} else {
return null;
}
...
return iter__5627__auto__(cljs.core.deref(e.cache));
});
...
var G__26901 = null;
var G__26901__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__26614 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__26616 = null;
var count__26617 = (0);
var i__26618 = (0);
while(true){
if((i__26618 < count__26617)){
var vec__26650 = chunk__26616.cljs$core$IIndexed$_nth$arity$2(null,i__26618);
...
var G__26906 = seq__26614;
var G__26907 = chunk__26616;
var G__26908 = count__26617;
var G__26909 = (i__26618 + (1));
seq__26614 = G__26906;
chunk__26616 = G__26907;
count__26617 = G__26908;
i__26618 = G__26909;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__26614);
if(temp__5825__auto__){
var seq__26614__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__26614__$1)){
var c__5672__auto__ = cljs.core.chunk_first(seq__26614__$1);
var G__26914 = cljs.core.chunk_rest(seq__26614__$1);
var G__26915 = c__5672__auto__;
var G__26916 = cljs.core.count(c__5672__auto__);
var G__26917 = (0);
seq__26614 = G__26914;
chunk__26616 = G__26915;
count__26617 = G__26916;
i__26618 = G__26917;
continue;
} else {
var vec__26659 = cljs.core.first(seq__26614__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26659,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26659,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__26922 = cljs.core.next(seq__26614__$1);
var G__26923 = null;
var G__26924 = (0);
var G__26925 = (0);
seq__26614 = G__26922;
chunk__26616 = G__26923;
count__26617 = G__26924;
i__26618 = G__26925;
continue;
}
} else {
...
var G__26901__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__26667 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__26669 = null;
var count__26670 = (0);
var i__26671 = (0);
while(true){
if((i__26671 < count__26670)){
var vec__26698 = chunk__26669.cljs$core$IIndexed$_nth$arity$2(null,i__26671);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26698,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26698,(1),null);
f.call(use_as_this,v,a,this$);


var G__26930 = seq__26667;
var G__26931 = chunk__26669;
var G__26932 = count__26670;
var G__26933 = (i__26671 + (1));
seq__26667 = G__26930;
chunk__26669 = G__26931;
count__26670 = G__26932;
i__26671 = G__26933;
continue;
} else {
var temp__5825__auto__ = cljs.core.seq(seq__26667);
if(temp__5825__auto__){
var seq__26667__$1 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__26667__$1)){
var c__5672__auto__ = cljs.core.chunk_first(seq__26667__$1);
var G__26934 = cljs.core.chunk_rest(seq__26667__$1);
var G__26935 = c__5672__auto__;
var G__26936 = cljs.core.count(c__5672__auto__);
var G__26937 = (0);
seq__26667 = G__26934;
chunk__26669 = G__26935;
count__26670 = G__26936;
i__26671 = G__26937;
continue;
} else {
var vec__26703 = cljs.core.first(seq__26667__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26703,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26703,(1),null);
f.call(use_as_this,v,a,this$);


var G__26946 = cljs.core.next(seq__26667__$1);
var G__26947 = null;
var G__26948 = (0);
var G__26949 = (0);
seq__26667 = G__26946;
chunk__26669 = G__26947;
count__26670 = G__26948;
i__26671 = G__26949;
continue;
}
} else {
...
G__26901 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__26901__1.call(this,f);
case 2:
return G__26901__2.call(this,f,use_as_this);
}
...
var G__26711 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__26711);
} else {
return G__26711;
}
}
...
(datascript.impl.entity.Entity.prototype.call = (function (unused__11847__auto__){
var self__ = this;
var self__ = this;
var G__26761 = (arguments.length - (1));
switch (G__26761) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args26604){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args26604)));
}));
...
(datascript.impl.entity.Entity.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"datascript.impl.entity/Entity");
}));
...
var temp__5827__auto__ = (function (){var fexpr__26813 = cljs.core.deref(this$.cache);
return (fexpr__26813.cljs$core$IFn$_invoke$arity$1 ? fexpr__26813.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__26813.call(null,attr));
})();
...
var temp__5825__auto___27028 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5825__auto___27028)){
var datoms_27029 = temp__5825__auto___27028;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_27029)));
