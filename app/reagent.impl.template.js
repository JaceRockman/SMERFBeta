...
var G__33821 = o;
reagent.impl.template.goog$module$goog$object.set(G__33821,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__34083__delegate = function (args){
...
while (G__34085__i < G__34085__a.length) {G__34085__a[G__34085__i] = arguments[G__34085__i + 0]; ++G__34085__i;}
  args = new cljs.core.IndexedSeq(G__34085__a,0,null);
} 
return G__34083__delegate.call(this,args);};
G__34083.cljs$lang$maxFixedArity = 0;
G__34083.cljs$lang$applyTo = (function (arglist__34086){
var args = cljs.core.seq(arglist__34086);
return G__34083__delegate(args);
});
...
var G__33848 = o;
reagent.impl.template.goog$module$goog$object.set(G__33848,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__34092__i < G__34092__a.length) {G__34092__a[G__34092__i] = arguments[G__34092__i + 0]; ++G__34092__i;}
  args = new cljs.core.IndexedSeq(G__34092__a,0,null);
} 
return G__34091__delegate.call(this,args);};
G__34091.cljs$lang$maxFixedArity = 0;
G__34091.cljs$lang$applyTo = (function (arglist__34094){
var args = cljs.core.seq(arglist__34094);
...
var G__33856 = props;
var G__33856__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33856,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33856);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33856__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__33872 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33872,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__33872;
}
})(),id_class);
...
var G__33893 = (cljs.core.count(argv) - first_child);
switch (G__33893) {
case (0):
...
var vec__33937 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33937,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33937,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33937,(2),null);
...
var temp__5808__auto___34104 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___34104 == null)){
} else {
var key_34107 = temp__5808__auto___34104;
(jsprops.key = key_34107);
}
...
var temp__5808__auto___34108 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___34108 == null)){
} else {
var key_34109 = temp__5808__auto___34108;
(jsprops.key = key_34109);
}
...
var temp__5808__auto___34113 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___34113 == null)){
} else {
var key_34114 = temp__5808__auto___34113;
(jsprops.key = key_34114);
}
...
var temp__5808__auto___34122 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___34122 == null)){
} else {
var key_34123 = temp__5808__auto___34122;
(jsprops.key = key_34123);
}
...
var temp__5808__auto___34124 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___34124 == null)){
} else {
var key_34125 = temp__5808__auto___34124;
(jsprops.key = key_34125);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33974_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__33974_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__33982 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33982,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33982,(1),null);
...
break;
default:
var G__34130 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__34131 = compiler;
v = G__34130;
compiler = G__34131;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template34024 = (function (opts,id,fn_to_element,parse_fn,meta34025){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template34024.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34026,meta34025__$1){
var self__ = this;
var _34026__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template34024(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta34025__$1));
}));

(reagent.impl.template.t_reagent$impl$template34024.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34026){
var self__ = this;
var _34026__$1 = this;
return self__.meta34025;
}));

(reagent.impl.template.t_reagent$impl$template34024.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template34024.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template34024.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template34024.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template34024.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template34024.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta34025","meta34025",-734719813,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template34024.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template34024.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template34024");

(reagent.impl.template.t_reagent$impl$template34024.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template34024");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template34024.
 */
reagent.impl.template.__GT_t_reagent$impl$template34024 = (function reagent$impl$template$__GT_t_reagent$impl$template34024(opts,id,fn_to_element,parse_fn,meta34025){
return (new reagent.impl.template.t_reagent$impl$template34024(opts,id,fn_to_element,parse_fn,meta34025));
});
...
return (new reagent.impl.template.t_reagent$impl$template34024(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
