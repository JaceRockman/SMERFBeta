...
var G__34969 = db;
var G__34970 = e;
var G__34971 = cljs.core.volatile_BANG_(false);
var G__34972 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__34969,G__34970,G__34971,G__34972) : datascript.impl.entity.__GT_Entity.call(null,G__34969,G__34970,G__34971,G__34972));
} else {
return null;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34973_SHARP_,p2__34974_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__34973_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__34974_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34975_SHARP_,p2__34976_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__34975_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__34976_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__34978_SHARP_,p2__34979_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__34978_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__34979_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__5523__auto__ = (function datascript$impl$entity$js_seq_$_iter__34984(s__34985){
return (new cljs.core.LazySeq(null,(function (){
var s__34985__$1 = s__34985;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__34985__$1);
if(temp__5804__auto__){
var s__34985__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__34985__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__34985__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__34987 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__34986 = (0);
while(true){
if((i__34986 < size__5522__auto__)){
var vec__34990 = cljs.core._nth(c__5521__auto__,i__34986);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34990,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34990,(1),null);
cljs.core.chunk_append(b__34987,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__35152 = (i__34986 + (1));
i__34986 = G__35152;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34987),datascript$impl$entity$js_seq_$_iter__34984(cljs.core.chunk_rest(s__34985__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34987),null);
}
} else {
var vec__34993 = cljs.core.first(s__34985__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34993,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34993,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__34984(cljs.core.rest(s__34985__$2)));
}
} else {
return null;
}
...
var G__35154 = null;
var G__35154__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__35003 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__35004 = null;
var count__35005 = (0);
var i__35006 = (0);
while(true){
if((i__35006 < count__35005)){
var vec__35013 = chunk__35004.cljs$core$IIndexed$_nth$arity$2(null,i__35006);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35013,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35013,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__35155 = seq__35003;
var G__35156 = chunk__35004;
var G__35157 = count__35005;
var G__35158 = (i__35006 + (1));
seq__35003 = G__35155;
chunk__35004 = G__35156;
count__35005 = G__35157;
i__35006 = G__35158;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__35003);
if(temp__5804__auto__){
var seq__35003__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__35003__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__35003__$1);
var G__35159 = cljs.core.chunk_rest(seq__35003__$1);
var G__35160 = c__5568__auto__;
var G__35161 = cljs.core.count(c__5568__auto__);
var G__35162 = (0);
seq__35003 = G__35159;
chunk__35004 = G__35160;
count__35005 = G__35161;
i__35006 = G__35162;
continue;
} else {
var vec__35019 = cljs.core.first(seq__35003__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35019,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35019,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__35165 = cljs.core.next(seq__35003__$1);
var G__35166 = null;
var G__35167 = (0);
var G__35168 = (0);
seq__35003 = G__35165;
chunk__35004 = G__35166;
count__35005 = G__35167;
i__35006 = G__35168;
continue;
}
} else {
...
var G__35154__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__35027 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__35028 = null;
var count__35029 = (0);
var i__35030 = (0);
while(true){
if((i__35030 < count__35029)){
var vec__35054 = chunk__35028.cljs$core$IIndexed$_nth$arity$2(null,i__35030);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35054,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35054,(1),null);
f.call(use_as_this,v,a,this$);


var G__35169 = seq__35027;
var G__35170 = chunk__35028;
var G__35171 = count__35029;
var G__35172 = (i__35030 + (1));
seq__35027 = G__35169;
chunk__35028 = G__35170;
count__35029 = G__35171;
i__35030 = G__35172;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__35027);
if(temp__5804__auto__){
var seq__35027__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__35027__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__35027__$1);
var G__35173 = cljs.core.chunk_rest(seq__35027__$1);
var G__35174 = c__5568__auto__;
var G__35175 = cljs.core.count(c__5568__auto__);
var G__35176 = (0);
seq__35027 = G__35173;
chunk__35028 = G__35174;
count__35029 = G__35175;
i__35030 = G__35176;
continue;
} else {
var vec__35058 = cljs.core.first(seq__35027__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35058,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35058,(1),null);
f.call(use_as_this,v,a,this$);


var G__35177 = cljs.core.next(seq__35027__$1);
var G__35178 = null;
var G__35179 = (0);
var G__35180 = (0);
seq__35027 = G__35177;
chunk__35028 = G__35178;
count__35029 = G__35179;
i__35030 = G__35180;
continue;
}
} else {
...
G__35154 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__35154__1.call(this,f);
case 2:
return G__35154__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__35154.cljs$core$IFn$_invoke$arity$1 = G__35154__1;
G__35154.cljs$core$IFn$_invoke$arity$2 = G__35154__2;
return G__35154;
})()
);
...
var G__35063 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__35063);
} else {
return G__35063;
}
}
...
(datascript.impl.entity.Entity.prototype.call = (function (unused__11791__auto__){
var self__ = this;
var self__ = this;
var G__35085 = (arguments.length - (1));
switch (G__35085) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args35001){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args35001)));
}));
...
var temp__5806__auto__ = (function (){var fexpr__35128 = cljs.core.deref(this$.cache);
return (fexpr__35128.cljs$core$IFn$_invoke$arity$1 ? fexpr__35128.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__35128.call(null,attr));
})();
...
var temp__5804__auto___35220 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5804__auto___35220)){
var datoms_35225 = temp__5804__auto___35220;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_35225)));
