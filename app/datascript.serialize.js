...
if((!((next_attr == null)))){
var G__37658 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(attrs,next_attr);
attrs = G__37658;
continue;
} else {
 ...
 * avet     :: [<index in eavt> ...]
 */
datascript.serialize.serializable_impl = (function datascript$serialize$serializable_impl(db,p__37557){
var map__37558 = p__37557;
var map__37558__$1 = cljs.core.__destructure_map(map__37558);
var freeze_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37558__$1,new cljs.core.Keyword(null,"freeze-fn","freeze-fn",-575885995),cljs.core.pr_str);
var freeze_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37558__$1,new cljs.core.Keyword(null,"freeze-kw","freeze-kw",391758233),datascript.serialize.freeze_kw);
...
var e = d.e;
var a = (function (){var G__37578 = d.a;
return (attrs_map.cljs$core$IFn$_invoke$arity$1 ? attrs_map.cljs$core$IFn$_invoke$arity$1(G__37578) : attrs_map.call(null,G__37578));
})();
var v = write_v(d.v);
...
var schema = (function (){var G__37579 = new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1(db);
return (freeze_fn.cljs$core$IFn$_invoke$arity$1 ? freeze_fn.cljs$core$IFn$_invoke$arity$1(G__37579) : freeze_fn.call(null,G__37579));
})();
...
(datascript.serialize.from_serializable.cljs$core$IFn$_invoke$arity$2 = (function (from,p__37616){
var map__37617 = p__37616;
var map__37617__$1 = cljs.core.__destructure_map(map__37617);
var thaw_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37617__$1,new cljs.core.Keyword(null,"thaw-fn","thaw-fn",-240544261),clojure.edn.read_string);
var thaw_kw = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__37617__$1,new cljs.core.Keyword(null,"thaw-kw","thaw-kw",1076733097),datascript.serialize.thaw_kw);
var tx0 = datascript.serialize.dict_get(from,"tx0");
var schema = (function (){var G__37618 = datascript.serialize.dict_get(from,"schema");
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__37618) : thaw_fn.call(null,G__37618));
})();
var _ = (function (){var fexpr__37625 = new cljs.core.Var(function(){return datascript.db.validate_schema;},new cljs.core.Symbol("datascript.db","validate-schema","datascript.db/validate-schema",-783030261,null),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"private","private",-558947994),new cljs.core.Keyword(null,"ns","ns",441598760),new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"file","file",-1269645878),new cljs.core.Keyword(null,"end-column","end-column",1425389514),new cljs.core.Keyword(null,"column","column",2078222095),new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.Keyword(null,"end-line","end-line",1837326455),new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"doc","doc",1913296891),new cljs.core.Keyword(null,"test","test",577538877)],[true,new cljs.core.Symbol(null,"datascript.db","datascript.db",-444456104,null),new cljs.core.Symbol(null,"validate-schema","validate-schema",758884380,null),"datascript/db.cljc",23,1,811,811,cljs.core.list(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"schema","schema",58529736,null)], null)),null,(cljs.core.truth_(datascript.db.validate_schema)?datascript.db.validate_schema.cljs$lang$test:null)]));
return (fexpr__37625.cljs$core$IFn$_invoke$arity$1 ? fexpr__37625.cljs$core$IFn$_invoke$arity$1(schema) : fexpr__37625.call(null,schema));
})();
...
var pred__37634 = cljs.core._EQ__EQ_;
var expr__37635 = marker;
if(cljs.core.truth_((pred__37634.cljs$core$IFn$_invoke$arity$2 ? pred__37634.cljs$core$IFn$_invoke$arity$2((0),expr__37635) : pred__37634.call(null,(0),expr__37635)))){
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(keywords,datascript.serialize.array_get(v,(1)));
} else {
if(cljs.core.truth_((pred__37634.cljs$core$IFn$_invoke$arity$2 ? pred__37634.cljs$core$IFn$_invoke$arity$2((1),expr__37635) : pred__37634.call(null,(1),expr__37635)))){
var G__37637 = datascript.serialize.array_get(v,(1));
return (thaw_fn.cljs$core$IFn$_invoke$arity$1 ? thaw_fn.cljs$core$IFn$_invoke$arity$1(G__37637) : thaw_fn.call(null,G__37637));
} else {
if(cljs.core.truth_((pred__37634.cljs$core$IFn$_invoke$arity$2 ? pred__37634.cljs$core$IFn$_invoke$arity$2((2),expr__37635) : pred__37634.call(null,(2),expr__37635)))){
return Infinity;
} else {
if(cljs.core.truth_((pred__37634.cljs$core$IFn$_invoke$arity$2 ? pred__37634.cljs$core$IFn$_invoke$arity$2((3),expr__37635) : pred__37634.call(null,(3),expr__37635)))){
return -Infinity;
} else {
if(cljs.core.truth_((pred__37634.cljs$core$IFn$_invoke$arity$2 ? pred__37634.cljs$core$IFn$_invoke$arity$2((4),expr__37635) : pred__37634.call(null,(4),expr__37635)))){
return NaN;
} else {
...
var aevt = (function (){var G__37638 = datascript.serialize.dict_get(from,"aevt");
if((G__37638 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__37595_SHARP_){
return (eavt[p1__37595_SHARP_]);
}),G__37638);
}
})();
var avet = (function (){var G__37639 = datascript.serialize.dict_get(from,"avet");
if((G__37639 == null)){
return null;
} else {
return datascript.serialize.amap((function (p1__37596_SHARP_){
return (eavt[p1__37596_SHARP_]);
}),G__37639);
}
})();
return datascript.db.restore_db(new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"schema","schema",-1582001791),schema,new cljs.core.Keyword(null,"eavt","eavt",-666437073),me.tonsky.persistent_sorted_set.from_sorted_array(datascript.db.cmp_datoms_eavt,eavt),new cljs.core.Keyword(null,"aevt","aevt",-585148059),me.tonsky.persistent_sorted_set.from_sorted_array(datascript.db.cmp_datoms_aevt,aevt),new cljs.core.Keyword(null,"avet","avet",1383857032),me.tonsky.persistent_sorted_set.from_sorted_array(datascript.db.cmp_datoms_avet,avet),new cljs.core.Keyword(null,"max-eid","max-eid",2134868075),datascript.serialize.dict_get(from,"max-eid"),new cljs.core.Keyword(null,"max-tx","max-tx",1119558339),datascript.serialize.dict_get(from,"max-tx")], null));
}));
